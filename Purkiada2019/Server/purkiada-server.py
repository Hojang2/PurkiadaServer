...
class Server:
    ...
    def load_users_file(self)-> None:
        ...
        """
        self.table = load_table.TableWorker(self.config["user_file"])
        self.table.get_text()
    ...
    def build_directory_structure(self):
        ...
        f1 = structures.File("ukol2.txt", "Tady je zakodovane heslo(je nutne ho dekodovat): 70 75 72 6b 69 61 64 61 ",
                             ["rwx", "rwx", "rwx"], "root", g)
